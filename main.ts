...
namespace View {
  ...
  export function update() {
    Elements.linesOfCode.innerHTML = Game.data.linesOfCode +
      " Lines of Code Written";
    Elements.forks.innerHTML = Game.data.forks + " Paper Fork" +
      (Game.data.forks > 1 ? "s" : "");
    ...
    Elements.getDeveloperFriend.innerHTML =
      ...
      " LoC";
    Elements.upgradeFriends.innerHTML = "Upgrade Friends (Currently Level " +
      Game.data.friendUpgrades +
      ") Cost: " +
      Purchase.upgradeFriends.calculateCost() +
      " LoC";
    Elements.forkText.innerHTML = "After " +
    ...
    Elements.upgradeDeveloperSkillLevel.disabled = !Purchase
      .upgradeDeveloperSkillLevel.canPurchase();
    Elements.getDeveloperFriend.disabled = !Purchase.getDeveloperFriend
      .canPurchase();
